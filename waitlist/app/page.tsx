  ...
  return (
    <div className="min-h-screen bg-[#111] text-[#e8e8e8] flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row flex-1">
        ...
        {/* Left */}
        <div className="lg:w-[380px] lg:shrink-0 lg:border-r border-b lg:border-b-0 border-[#1e1e1e] flex flex-col justify-center px-6 md:px-12 py-12 lg:py-20">
          ...
          <p className="text-[15px] text-[#aaa] leading-relaxed mb-8 max-w-xs">
        ...
        {/* Right */}
        <div className="flex-1 flex items-center justify-center px-6 md:px-12 py-12 lg:py-20">
